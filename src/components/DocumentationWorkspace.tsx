const docsSections = [
  {
    ...
    items: [
      ...
      "Save a Discord webhook in Settings to post a run summary with the queue name and targets hit after each real live run. Restart or download the local runner after saving the webhook so the runner can consume the saved setting. INWELL_DISCORD_WEBHOOK_URL remains available as a local-runner override.",
